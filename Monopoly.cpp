...
void initGame(int numPlayers)
{
	...
	board[1].owner = -1;
	board[1].rent = {2, 10, 30, 90, 160, 250};
	...
	board[3].owner = -1;
	board[3].rent = {4, 20, 60, 180, 320, 450};
	...
	board[5].owner = -1;
	board[5].rent = {25, 50, 100, 200, 0, 0};
	...
	board[6].owner = -1;
	board[6].rent = {6, 30, 90, 270, 400, 550};
	...
	board[8].owner = -1;
	board[8].rent = {6, 30, 90, 270, 400, 550};
	...
	board[9].owner = -1;
	board[9].rent = {8, 40, 100, 300, 450, 600};
	...
	board[11].owner = -1;
	board[11].rent = {10, 50, 150, 450, 625, 750};
	...
	board[13].owner = -1;
	board[13].rent = {10, 50, 150, 450, 625, 750};
	...
	board[14].owner = -1;
	board[14].rent = {12, 60, 180, 500, 700, 900};
	...
	board[15].owner = -1;
	board[15].rent = {25, 50, 100, 200, 0, 0};
	...
	board[16].owner = -1;
	board[16].rent = {14, 70, 200, 550, 750, 950};
	...
	board[18].owner = -1;
	board[18].rent = {14, 70, 200, 550, 750, 950};
	...
	board[19].owner = -1;
	board[19].rent = {16, 80, 220, 600, 800, 1000};
	...
	board[21].owner = -1;
	board[21].rent = {18, 90, 250, 700, 875, 1050};
	...
	board[23].owner = -1;
	board[23].rent = {18, 90, 250, 700, 875, 1050};
	...
	board[24].owner = -1;
	board[24].rent = {20, 100, 300, 750, 925, 110};
	...
	board[25].owner = -1;
	board[25].rent = {25, 50, 100, 200, 0, 0};
	...
	board[26].owner = -1;
	board[26].rent = {22, 110, 330, 800, 975, 1150};
	...
	board[27].owner = -1;
	board[27].rent = {22, 110, 330, 800, 975, 1150};
	...
	board[29].owner = -1;
	board[29].rent = {24, 120, 360, 850, 1025, 1200};
	...
	board[31].owner = -1;
	board[31].rent = {26, 130, 390, 900, 1100, 1275};
	...
	board[32].owner = -1;
	board[32].rent = {26, 130, 390, 900, 1100, 1275};
	...
	board[34].owner = -1;
	board[34].rent = {28, 150, 450, 1000, 1200, 1400};
	...
	board[35].owner = -1;
	board[35].rent = {25, 50, 100, 200, 0, 0};
	...
	board[37].owner = -1;
	board[37].rent = {35, 175, 500, 1100, 1300, 1500};
	...
	board[39].owner = -1;
	board[39].rent = {50, 200, 600, 1400, 1700, 2000};
}
...
void Move(int numOfSpaces)
{
	...
	{
	case _Property:
		//I figured since it's all global there's no need to pass in the current position
		Property();
		break;
	case _Railroad:
		//Changed because we'd need to pass in numOfRailroads of the owner
		//i.e. Railroad(players[board[players[curPlayer].curPos]].owner].numOfRailroads)
		//But if no one owns it board[players[curPlayer].curPos]].owner = -1 creating an
		//OutOfBoundsException in players[]
		Railroad();
		break;
	case _Utility:
		//Same for utilities
...
void Railroad()
{
	...
	else
	{
		...
		PayRent(board[curPos].rent[players[owner].numOfRailroads]);
	}
}
...
void Utility()
{
	...
	{
		//Might want to display die roll so user sees what is going on
		int dieRoll = (rand() % 12) + 1;
		if (players[owner].numOfUtilities == 1)
			PayRent(4 * dieRoll);
		else if (players[owner].numOfUtilities == 2)
			PayRent(10 * dieRoll);
	}
}
...
void IncomeTax()
{
	players[curPlayer].money -= 300;
}

void LuxuryTax()
{
	players[curPlayer].money -= 75;
}
